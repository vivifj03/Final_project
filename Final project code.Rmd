...
fit2 <- eBayes(fit2)
tt1 <- topTable(fit2, n = Inf, coef = "cerebellar.SvsC", adjust.method = "fdr", 
    p.value = 0.05)
tt2 <- topTable(fit2, n = Inf, coef = "DLPFC.SvsC", adjust.method = "fdr", 
    p.value = 0.05)
tt3 <- topTable(fit2, n = Inf, coef = "Diff", adjust.method = "fdr", p.value = 0.05)
